  ...
  },
{
    ...
    hand_base_picture =
    {
      filename = "__short-arms__/graphics/entity/fast-short-inserter/fast-short-inserter-hand-base.png",
      priority = "extra-high",
      width = 4,
      height = 17
    },
    hand_closed_picture =
    {
      filename = "__short-arms__/graphics/entity/fast-short-inserter/fast-short-inserter-hand-closed.png",
      priority = "extra-high",
      width = 9,
      height = 21
    },
    hand_open_picture =
    {
      filename = "__short-arms__/graphics/entity/fast-short-inserter/fast-short-inserter-hand-open.png",
      priority = "extra-high",
      width = 9,
      height = 21
    },
    ...
    platform_picture =
    {
      sheet =
      {
        filename = "__short-arms__/graphics/entity/fast-short-inserter/fast-short-inserter-platform.png",
        priority = "extra-high",
        width = 46,
        height = 46,
        shift = {0.09375, 0}
